    ...
    <form action="{{ route('testimonios.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-span-full xl:col-span-8 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
            <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Creación de nuevo testimonio</h2>
            </header>
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            <div class="md:col-span-5">
                                                ...
                                                <div class="relative mb-2  mt-2">
                                                    ...
                                                    <input type="text" id="name" name="name" value="" class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nombre">
                                                </div>
                                            </div>
                                            ...
                                            <div class="md:col-span-5">
                                                ...
                                                <div class="relative mb-2  mt-2">
                                                    ...
                                                    <input type="text" id="ocupation" name="ocupation" value="" class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Distrito">
                                                </div>
                                            </div>
                                            ...
                                            <div class="md:col-span-5">
                                                ...
                                                <div class="relative mb-2 mt-2">
                                                    ...
                                                    <textarea type="text" rows="2"  id="testimonie" name="testimonie" value="" class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Comentario"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="md:col-span-5">
                                                ...
                                                <div class="relative mb-2  mt-2">
                                                    ...
                                                    <input type="text" id="video" name="video" value="" class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Inserte link de youtube">
                                                </div>
                                            </div>
                                            ...
                                            <div class="md:col-span-5 text-right mt-6 flex justify-between">
                                                ...
                                                <div class="inline-flex items-end">
                                                <button type="submit"  class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded">Guardar testimonio</button>
                                                </div>
                                            </div>
                                </div>           
                    </div>
