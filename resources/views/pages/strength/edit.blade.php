<x-app-layout>
  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    <form action="{{ route('strength.update', $strength->id) }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div
        class="col-span-full xl:col-span-8 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
        <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
          <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Editar banner
          </h2>
        </header>
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  <input type="text" id="titulo" name="titulo" value="{{ $strength->titulo }}"
              ...
              <div class="md:col-span-3">
                                ...
                                <div class="relative mb-2  mt-2">
                                    ...
                                    <input type="text" id="botontext1" name="botontext1" 
                                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Titulo para botón" value="{{ $strength->botontext1 }}">
                                </div>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative mb-2  mt-2">
                                    ...
                                    <input type="text" id="link1" name="link1" value="{{ $strength->link1 }}"
                                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  <input id="imagen" name="imagen" value="{{ $strength->imagen }}"
                    class="p-2.5 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                    aria-describedby="user_avatar_help" id="user_avatar" type="file">
                </div>
              </div> --}}
