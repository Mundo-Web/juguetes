    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div
            ...
            <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Lista de banners
                </h2>
            </header>
            <div class="p-3">
                                    ...
                                    <td>
                                        <form method="POST" action="">
                                          ...
                                          before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-gray-400 dark:checked:before:bg-blue-200"
                                                id='{{ 'v_' . $item->id }}' data-field='status'
...
<script>
    $('document').ready(function() {
        ...
        $('#tabladatos').on('change', '.btn_swithc', function() {    
            ...
            $.ajax({
                url: "{{ route('strength.updateVisible') }}",
                method: 'POST',
                data: {
